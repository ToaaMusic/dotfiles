...
hl(0, "FloatBorder", { bg = "none", fg = colors.bg_border, bold = true })
...
hl(0, "@markup.raw", { fg = syntax.builtin, bg = "none" })
...
hl(0, "@markup.heading.1.markdown", { fg = colors.fg })
hl(0, "@markup.heading.2.markdown", { fg = colors.fg })
hl(0, "@markup.heading.3.markdown", { fg = colors.fg })
hl(0, "@markup.heading.4.markdown", { fg = colors.fg })
hl(0, "@markup.heading.5.markdown", { fg = colors.fg })
hl(0, "@markup.heading.6.markdown", { fg = colors.fg })
hl(0, "@tag", { fg = syntax.type })
...
hl(0, "RenderMarkdownH1Bg", { fg = colors.fg })
hl(0, "RenderMarkdownH2Bg", { fg = colors.fg })
hl(0, "RenderMarkdownH3Bg", { fg = colors.fg })
hl(0, "RenderMarkdownH4Bg", { fg = colors.fg })
hl(0, "RenderMarkdownH5Bg", { fg = colors.fg })
hl(0, "RenderMarkdownH6Bg", { fg = colors.fg })
hl(0, "RenderMarkdownCode", { bg = colors.bg })
hl(0, "RenderMarkdownCodeInline", { bg = colors.bg })
-- hl(0, "RenderMarkdownCodeInfo", { fg = colors.fg })
hl(0, "RenderMarkdownCodeBorder", { fg = colors.fg })
