...
local function write_hypr(p)
  ...
  f:write("-- Do not edit manually! Overrides vars.lua border colors.\n\n")
  f:write("return {\n")
...
function M.apply(p)
  ...
  -- Mako
  local mako_path = os.getenv("HOME") .. "/.config/mako/g.colors"
  os.execute("mkdir -p " .. mako_path:match("(.*/)"))
  local mako_f = assert(io.open(mako_path, "w"))
  mako_f:write("# Auto-generated by wallpaper gen.lua\n")
  mako_f:write(string.format("background-color=%s\n", p.bg))
  mako_f:write(string.format("text-color=%s\n", p.fg))
  mako_f:write(string.format("border-color=%s\n", p.bg_border))
  mako_f:close()
